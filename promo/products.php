...
<div class="uk-section">
    <div class="uk-container">
        <h1 class="uk-heading-2xlarge uk-animation-fade">PRODUCTS</h1>
    </div>
</div>
<div class="uk-section uk-animation-fade uk-animation-slide-bottom">
    ...
    <!-- <div class="uk-container">
        <article class="uk-article uk-margin-bottom">
            ...
            <p class="uk-article-meta">Written by <a href="#">Jan Minne Holwerda</a> on 10 Novembre 2020. Posted in <a href="#">Products</a></p>
